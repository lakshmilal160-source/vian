            ...
            <div class="contact-body-container">
                ...
                <div class="contact-info-col">
                    ...
                    <div class="cinfo-block">
                        ...
                        <a href="tel:+12351251281" class="cinfo-action-link cinfo-link-orange">
                            <span class="cinfo-icon-circle cinfo-icon-orange">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.89 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.8 1.2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 5.55 5.55l1.28-1.34a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                            </span>
                    ...
                    <div class="cinfo-block">
                        ...
                        <a href="https://maps.google.com/?q=1234+Divi+St.+San+Francisco+CA" target="_blank" rel="noopener" class="cinfo-action-link cinfo-link-orange">
                            <span class="cinfo-icon-circle cinfo-icon-orange">
