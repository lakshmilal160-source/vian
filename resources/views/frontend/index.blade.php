            ...
            <div class="hero-sticky-viewport">
                ...
                <div class="hero-title-group" id="titleGroup">
                    ...
                    <p class="hero-sub-caption" id="subCaption">
                        Human domain expertise and white-gloss robotic intelligence uniting to architect clean, scalable IT software.
                    </p>
                </div>
                ...
                <div class="hands-stage" id="handsStage">
                    ...
                    <div class="hand-wrapper left-hand" id="leftHandWrapper">
                        <div class="hand-visual">
                            ...
                            <img src="assets/frontend/img/human_hand_left.png" alt="Human Hand reaching from left" class="hand-img img-human-left" id="leftHandImg" onerror="this.style.display='none'">
                            ...
                            <div class="svg-hand-container" id="leftHandSvg" style="display: none;">
                                <svg viewBox="0 0 600 250" class="vector-arm vector-human-left">
                                    <defs>
                                        <linearGradient id="skinGradLeft" x1="0%" y1="0%" x2="100%" y2="0%">
                                        ...
                                        <linearGradient id="skinShadeLeft" x1="0%" y1="0%" x2="0%" y2="100%">
                                            <stop offset="0%" stop-color="#ffffff" stop-opacity="0.25"/>
                                            <stop offset="100%" stop-color="#000000" stop-opacity="0.18"/>
                                        </linearGradient>
                                    </defs>
                                    <!-- Forearm entering from left -->
                                    <path d="M0 65 C90 70 170 85 240 100 L260 165 C180 180 100 175 0 165 Z" fill="url(#skinGradLeft)"/>
                                    <path d="M0 65 C90 70 170 85 240 100 L260 165 C180 180 100 175 0 165 Z" fill="url(#skinShadeLeft)"/>
                                    <!-- Wrist & Palm -->
                                    <path d="M240 100 C290 102 340 105 380 112 L400 165 C350 185 290 180 260 165 Z" fill="url(#skinGradLeft)"/>
                                    <!-- Folded lower fingers -->
                                    <path d="M380 135 C405 150 430 165 415 185 C400 200 375 180 365 165" fill="none" stroke="url(#skinGradLeft)" stroke-width="22" stroke-linecap="round"/>
                                    <path d="M365 145 C385 160 405 180 390 195 C380 205 355 185 350 170" fill="none" stroke="url(#skinGradLeft)" stroke-width="18" stroke-linecap="round"/>
                                    <!-- Extended Index Finger reaching right towards center -->
                                    <g class="human-index-group">
                                        <path d="M380 112 C420 114 470 117 520 120 L522 136 C470 134 420 133 380 132 Z" fill="url(#skinGradLeft)"/>
                                        <path d="M380 112 C420 114 470 117 520 120 L522 136 C470 134 420 133 380 132 Z" fill="url(#skinShadeLeft)"/>
                                        <path d="M520 120 C555 122 580 124 595 124 C580 128 555 133 522 136 Z" fill="url(#skinGradLeft)"/>
                                        <!-- Fingertip glow spot -->
                    ...
                    <div class="synapse-spark-zone" id="sparkZone">
                        ...
                        <div class="touch-scroll-prompt" id="touchScrollDownPrompt" onclick="window.scrollBy({top: 600, behavior: 'smooth'})" title="Scroll Down To Explore">
                    ...
                    <div class="hand-wrapper right-hand" id="rightHandWrapper">
                        <div class="hand-visual">
                            <!-- AI Generated PNG Hand -->
                            <img src="assets/frontend/img/robotic_hand_right.png" alt="Sleek White Ceramic Robotic Hand pointing left" class="hand-img img-robotic-right" id="rightHandImg" onerror="this.style.display='none'">
                            ...
                            <div class="svg-hand-container" id="rightHandSvg" style="display: none;">
                                <svg viewBox="0 0 600 250" class="vector-arm vector-robotic-right">
                                    <defs>
                                        <linearGradient id="whiteCeramicGrad" x1="100%" y1="0%" x2="0%" y2="0%">
                                            <stop offset="0%" stop-color="#475569" />
                                            <stop offset="30%" stop-color="#e2e8f0" />
                                            <stop offset="65%" stop-color="#ffffff" />
                                            <stop offset="100%" stop-color="#f8fafc" />
                                        </linearGradient>
                                        <linearGradient id="purpleChrome" x1="0%" y1="0%" x2="100%" y2="100%">
                                    ...
                                    <path d="M600 60 L420 70 L360 105 L340 145 L420 170 L600 160 Z" fill="url(#whiteCeramicGrad)" stroke="#cbd5e1" stroke-width="2"/>
                                    <path d="M580 75 C520 75 460 85 410 105 L440 155 C490 145 540 145 590 145 Z" fill="#ffffff" opacity="0.95"/>
                                    <!-- Wrist Carbon & Purple LED Joint -->
                                    <circle cx="330" cy="125" r="32" fill="#1e293b" stroke="#9333ea" stroke-width="2.5" filter="url(#purpleGlow)"/>
                                    <circle cx="330" cy="125" r="18" fill="#a855f7" opacity="0.9" filter="url(#purpleGlow)"/>
                                    <!-- Palm & Lower fingers -->
                                    <path d="M300 100 L230 105 L190 135 L210 175 L270 185 L305 155 Z" fill="url(#whiteCeramicGrad)" stroke="#94a3b8" stroke-width="2"/>
                                    <!-- Folded fingers (Middle, Ring, Pinky) -->
                                    <path d="M230 140 C205 150 180 165 195 185 C210 200 235 180 245 165" fill="none" stroke="url(#whiteCeramicGrad)" stroke-width="22" stroke-linecap="round"/>
                                    <circle cx="220" cy="165" r="4" fill="#a855f7"/>
                                    <path d="M240 155 C220 168 200 185 215 205 C230 220 255 195 260 180" fill="none" stroke="url(#whiteCeramicGrad)" stroke-width="18" stroke-linecap="round"/>
                                    <!-- Extended Index Finger reaching left towards center -->
                                    <g class="robotic-index-group">
                                        <path d="M230 110 L150 112 L145 132 L230 132 Z" fill="url(#whiteCeramicGrad)" stroke="#64748b" stroke-width="1.5"/>
                                        <circle cx="148" cy="122" r="7" fill="#1e293b" stroke="#a855f7" stroke-width="1.5" filter="url(#purpleGlow)"/>
                                        <path d="M145 113 L75 116 L72 131 L145 131 Z" fill="url(#whiteCeramicGrad)" stroke="#64748b" stroke-width="1.5"/>
                                        <circle cx="74" cy="123.5" r="6" fill="#1e293b" stroke="#a855f7" stroke-width="1.5" filter="url(#purpleGlow)"/>
                                        <path d="M72 116 C45 117 20 120 5 124 C20 128 45 130 72 130 Z" fill="url(#whiteCeramicGrad)" stroke="#a855f7" stroke-width="1.5"/>
                                        <!-- Glowing tip LED -->
                                        <circle cx="6" cy="124" r="5" fill="#c084fc" filter="url(#purpleGlow)"/>
                                    </g>
                                </svg>
                            </div>
                        </div>
                ...
                <div class="hero-footer-bar">
                    ...
                    <div class="scroll-down-indicator" id="scrollPrompt" onclick="window.scrollBy({top: 450, behavior: 'smooth'})" title="Scroll down">
            ...
            <div class="ecosystem-container">
                ...
                <div class="ecosystem-about-header">
                    ...
                    <p class="ecosystem-main-statement">
                        VIAN Consultancy Services combines technology and domain expertise for intelligent digital transformation you trust. We built <span class="cyan-highlight">a custom software & KPO platform that protects your data</span> while delivering enterprise-grade AI automation. Every solution is backed by engineering excellence and <span class="cyan-highlight">every architecture is designed for your unique business operations.</span>
                    </p>
                </div>
                ...
                <div class="infographic-right-col">
                    ...
                    <div class="infographic-row-item">
                        <div class="row-icon-circle">
                            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 3.79 2 6v12c0 2.21 4.48 4 10 4s10-1.79 10-4V6c0-2.21-4.48-4-10-4zm0 2c4.41 0 8 1.34 8 2s-3.59 2-8 2-8-1.34-8-2 3.59-2 8-2zm0 6c4.41 0 8 1.34 8 2s-3.59 2-8 2-8-1.34-8-2 3.59-2 8-2zm0 6c4.41 0 8 1.34 8 2s-3.59 2-8 2-8-1.34-8-2 3.59-2 8-2z"/></svg>
                        </div>
                        <div class="row-text-content">
                            <h4 class="row-item-title">Business-First Thinking</h4>
                            <p class="row-item-desc">Some transactions may be subject to tax that may be added to the list price handling</p>
                        </div>
                    </div>
                ...
                <div class="client-marquee-wrapper">
                    <div class="client-marquee-track">
                        ...
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_1_microsoft.svg" alt="Microsoft Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_2_aws.svg" alt="Amazon Web Services Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_3_stripe.svg" alt="Stripe Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_4_google.svg" alt="Google Cloud Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_5_snowflake.svg" alt="Snowflake Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_6_salesforce.svg" alt="Salesforce Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_7_oracle.svg" alt="Oracle Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_8_cisco.svg" alt="Cisco Logo" class="client-logo-img">
                        </div>
                        <!-- Group 2 (Duplicate for seamless infinity loop) -->
                        <div class="client-logo-card">
                            <img src="assets/frontend/img/client_logo_1_microsoft.svg" alt="Microsoft Logo" class="client-logo-img">
                        </div>
                        <div class="client-logo-card">
